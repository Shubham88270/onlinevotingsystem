    ...
    <nav className="bg-indigo-700 shadow-md">
      ...
      {menuOpen && (
        <div className="md:hidden bg-indigo-800 px-4 pb-4 space-y-1">
          ...
          <Link to="/blogs" onClick={() => setMenuOpen(false)} className="block text-white py-2 px-3 rounded-lg hover:bg-indigo-600 text-sm">
            📝 Blog
          </Link>
          <Link to="/faq" onClick={() => setMenuOpen(false)} className="block text-white py-2 px-3 rounded-lg hover:bg-indigo-600 text-sm">
            ❓ FAQ
          </Link>
